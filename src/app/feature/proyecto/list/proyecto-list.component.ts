...
@Component({selector: 'app-proyecto-list', templateUrl: './proyecto-list.component.html', styleUrls: ['./proyecto-list.component.css']})
export class ProyectoListComponent implements OnInit {
    ...
    constructor(private proyectoService : ProyectoService, private route : ActivatedRoute, private router : Router, private dialog : MatDialog, private httpProvider : AvanceCumplimientoService, private miDatePipe : DatePipe) {}
    ...
    archiveProject(proyecto : ProyectoModels): void {
        this.proyectoService.archiveProject(proyecto.id).pipe(finalize(() => {
    ...
    openDialogArchiveProject(proyecto : ProyectoModels): void {
        const dialogRef = this.dialog.open(ModalAlertComponent, {
            ...
            data: {
                ...
                message: 'La solicitud será archivado y no podrá ser utilizado por los usuarios.',
                dato: [
                    'Nombre:', proyecto.name, 'Tipo de solicitud:', proyecto.name
                ],
    ...
    generar_informeControl() {
        ...
        this.router.navigate(['/system/docente-vinculacion/informe-control/'], {
            queryParams: {
                id_proyecto: this.proyectID
            }
        });
    }
    ...
    generar_informeInicail() {
        ...
        this.router.navigate(['/system/docente-vinculacion/informe-inicial/'], {
            queryParams: {
                id_proyecto: this.proyectID
            }
        });
    ...
    public pdf() {
        ...
        const pageContent6 = (data : any) => { // HEADER
            ...
            this.doc.text('Verificar la disponibilidad tecnológica de equipos informáticos para el alojamiento y programación del sistema web ', 400, 330,{maxWidth: 100,
            align: 'justify'});
            this.doc.line(40, 460, 555, 460);
    ...
    public pdf_convenio() {
        ...
        const pageContent = (data : any) => { // HEADER
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text(this.proyectData.beneficiary_institution_id.name, 300, 260, {
                maxWidth: 555,
                align: 'center'
            });
            const regex = /[\*][\w\W]*[\*]/gmi;
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('Comparecen a la celebración del presente Convenio, por una parte el ' + this.proyectData.beneficiary_institution_id.name + ', legalmente representado por el ' + this.proyectData.beneficiary_institution_id.name + ', en su calidad de Rector, de conformidad con lo establecido en la Resolución No. ' + 320 + ' y Acción de Personal No. ' + this.proyectData.code + 'de ' + month_dia + ' de ' + months[month_value] + ' de ' + año + '; delegado del Secretario de' + ' Educación Superior, Ciencia, Tecnología e Innovación, para suscribir el presente ' + 'instrumento conforme al Acuerdo No. 2020-048 de 15 de mayo de 2020,' + 'a quien en adelante para los efectos del presente instrumento se denominará “INSTITUTO”;' + 'y, por otra parte la empresa "' + this.replace(this.proyectData.beneficiary_institution_id.name, regex) + '" con RUC No. ' + this.proyectData.beneficiary_institution_id.ruc + ', representada legalmente por ' + this.proyectData.authorized_by.user_id.person.names + 'en calidad de Gerente General a quien en adelante y' + ' para los efectos del presente instrumento se denominará “ENTIDAD RECEPTORA”', 110, 285, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('Las partes libre y voluntariamente, acuerdan celebrar el presente convenio al tenor de las siguientes cláusulas: ', 110, 425, {
                maxWidth: 400,
                align: 'justify'
            });
        ...
        const pageContent2 = (data : any) => { // HEADER
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('6.  El artículo 125 de la Ley Orgánica de Educación Superior establece que: “Las instituciones del Sistema de Educación Superior realizarán programas y cursos de vinculación  con las sociedad guiados por el personal académico”.', 115, 265, {
                maxWidth: 400,
                align: 'justify'
            });
        ...
        const pageContent3 = (data : any) => {
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('14.EL ' + this.proyectData.name_institute + ', ubicado en la ciudad de Quito, provincia de pichincha, es una Institución de Educación Superior Pública, con licencia de funcionamiento otorgada mediante Acuerdo Nro. Xxx y registro institucionalNro.Xxxxx conferido por el Consejo de Educación Superior CONESUP, que se dedica a la formación de profesionales de nivel tecnológico.;', 115, 650, {
                maxWidth: 400,
                align: 'justify'
            });
        ...
        const pageContent4 = (data : any) => { // HEADER
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('15.   Mediante Informe Técnico Académico de Viabilidad para la firma de Convenio No. Xxxxxx de fecha xx de xxxxxxxx de 202x, se concluye que: “Conclusiones y Recomendaciones:”.', 115, 150, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            'a la implementación de un programa de vinculación con la colectividad que versará' + this.doc2.text('17.  Con los antecedentes expuestos, el Instituto Tecnológico Superior xxxxxx y el' + this.proyectData.beneficiary_institution_id.name + ' acuerdan suscribir el presente convenio referente' + 'a la implementación de un programa de vinculación con la colectividad que versará' + 'sobre el proyecto que tiene como objetivo:”', + this.proyectData.beneficiary_institution_id.name + ', por parte de las carreras de xxxxxxxxxxxxxxxxxxxxxx.', 115, 290, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('Por medio del presente convenio, las partes, en el ámbito de sus competencias, se comprometen a realizar la implementación del proyecto de vinculación con la colectividad' + 'propuesto por el INSTITUTO, referente a (NOMBRE DEL PROYECTO).', 115, 385, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('a) Designar a las y los estudiantes del INSTITUTO a fin de que accedan a las actividades de vinculación  en la ENTIDAD RECEPTORA, remitiendo para el efecto la base de datos con la información que acuerden las partes.', 155, 490, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('b) Asegurar que la  unidad de vinculación pueda desarrollar los distintos programas y actividades en las instalaciones existentes en la ENTIDAD RECEPTORA.', 155, 540, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('c) Cumplir a cabalidad las horas establecidas para el proyecto.', 155, 580, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('a) Permitir que los estudiantes del Instituto Tecnológico Superior xxxxxxxxx efectúen actividades de vinculación en las instalaciones de acuerdo a los lineamientos pedagógicos establecidos.', 155, 640, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('b) Vincular a las y los estudiantes a las áreas relacionadas con la carrera que se encuentren cursando la correspondiente actividad de vinculación en sus instalaciones, de acuerdo a las necesidades de la ENTIDAD RECEPTORA y de conformidad a la normativa vigente.', 155, 685, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('c) Otorgar el apoyo necesario para el desarrollo de los estudiantes y sus actividades, además de evaluar el desarrollo de las actividades que se asignen a los estudiantes dentro de las actividades de vinculación  a realizarse en la ENTIDAD RECEPTORA', 155, 735, {
                maxWidth: 350,
                align: 'justify'
            });
        ...
        const pageContent5 = (data : any) => { // HEADER
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('El presente Convenio de Vinculación con la Sociedad tendrá la vigencia de (1) un año contados a partir de la fecha de suscripción, mismo que podrá ser renovado previo ' + 'consentimiento de las partes de manera escrita con un mínimo de quince (15) días de anticipación a la fecha de terminación, para lo cual las partes deberán suscribir el instrumento pertinente prorrogando' + + 'el mismo y estableciendo, de existir, las nuevas condiciones.', 110, 165, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('Debido a la naturaleza del Convenio, el presente convenio no generará obligaciones financieras recíprocas, erogación alguna ni transferencias de recursos económicos' + ' entre las partes; las erogaciones generadas por las acciones ejecutadas por el cumplimiento de las obligaciones contraídas en el presente instrumento serán asumidas con cargo a la Institución que las ejecute.', 110, 250, {
                maxWidth: 400,
                align: 'justify'
            });
        ...
        const pageContent6 = (data : any) => { // HEADER
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('3.  Por terminación unilateral por incumplimiento de una de las partes, lo cual deberá ser técnicamente y legalmente justificado por quien lo alegaré; y, ', 110, 150, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('Por la naturaleza del presente Convenio, se entiende que ninguna de las partes comparecientes, adquieren relación laboral ni de dependencia respecto del personal de la otra institución que trabaje en el cumplimiento de este instrumento.' + 'De igual manera, la ENTIDAD RECEPTORA no tendrá relación laboral ni obligaciones laborales  con los estudiantes que se vinculen a ella, ni éstos tendrán subordinación ni dependencia laboral para con la ENTIDAD RECEPTORA, se aclara que la relación estudiante-entidad receptora es  únicamente de formación académica.', 110, 360, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('Forman parte integrante del convenio los siguientes documentos:', 110, 620, {
                maxWidth: 400,
                align: 'justify'
            });
            this.doc2.text('a)	Los que acreditan la calidad y capacidad de los comparecientes; y,', 120, 635, {
                maxWidth: 400,
                align: 'justify'
            });
            this.doc2.text('b)	Los documentos a que se hace referencia en la cláusula de antecedentes', 120, 645, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text('Todas las comunicaciones y notificaciones entre las partes, se realizarán por escrito y serán entregadas a las siguientes direcciones:', 110, 680, {
                maxWidth: 400,
                align: 'justify'
            });
        ...
        const pageContent7 = (data : any) => { // HEADER
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text(' direccion', 195, 170, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text(' direccion', 195, 185, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text(' direccion', 195, 200, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text(' direccion', 195, 215, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(10);
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text(' direccion', 195, 250, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text(' direccion', 195, 265, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text(' direccion', 195, 280, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc2.text(' direccion', 195, 295, {
                maxWidth: 400,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto", 'bold');
            this.doc2.text('“Por delegación del Secretario de Educación Superior, Ciencia, Tecnología e Innovación”:', 110, 415, {
                maxWidth: 185,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(11);
            this.doc2.setFont("Roboto", 'bold');
            this.doc2.text('Por la Entidad Receptora:', 350, 415, {
                maxWidth: 200,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(9);
            this.doc2.setFont("Roboto", 'bold');
            this.doc2.text('INSTITUTO TECNÓLOGICO SUPERIOR', 110, 500, {
                maxWidth: 200,
                align: 'justify'
            });
            ...
            this.doc2.setFontSize(9);
            this.doc2.setFont("Roboto", 'bold');
            this.doc2.text('EMPRESA:', 350, 500, {
                maxWidth: 200,
                align: 'justify'
            });
            this.doc2.text(this.proyectData.beneficiary_institution_id.name, 410, 500, {
                maxWidth: 200,
                align: 'justify'
            });

        }
        this.doc2.autoTable({addPageContent: pageContent})
        ...
        this.doc2.autoTable({addPageContent: pageContent3, startY: 2100})
        this.doc2.autoTable({addPageContent: pageContent3, startY: 3100})


        this.doc2.autoTable({addPageContent: pageContent5, startY: 3100})
        this.doc2.autoTable({addPageContent: pageContent6, startY: 3100})

        this.doc2.autoTable({addPageContent: pageContent7, startY: 3100})
    ...
    public pdf_itv() {
        ...
        const pageContent = (data : any) => { // HEADER
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.name_institute, 160, 215, {
                maxWidth: 500,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.miDatePipe.transform(this.proyectData.start_date, 'dd/MM/yyyy'), 160, 235, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Nombre de la Entidad Emisora:', 40, 270, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Nombre de la Entidad Receptora:', 40, 300, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Nombre de la persona  autorizada legalmente  para la suscripción del Convenio:', 40, 330, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Actividad económica que consta en el RUC:', 40, 385, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Plazo de vigencia del convenio:', 40, 430, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('N° de estudiantes que recibiría inicialmente la Entidad Receptora:', 40, 480, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.beneficiary_institution_id.number_students_start, 160, 490, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Total de estudiantes proyectados que recibirá la Entidad Receptora durante la vigencia del convenio:', 290, 470, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.beneficiary_institution_id.number_students_ability, 405, 490, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.line(40, 510, 555, 510);
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Datos: Tutor Académico', 40, 550, {
                maxWidth: 150,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('BARRIGA OLIVO SUSANJAC QUELINE', 160, 540, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Contacto: 022342563', 160, 560, {
                maxWidth: 150,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Datos: Tutor Académico', 290, 550, {
                maxWidth: 150,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('BARRIGA OLIVO SUSANJAC QUELINE', 395, 540, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Contacto: 022342563', 395, 560, {
                maxWidth: 150,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Correo electrónico de la empresa: (información obligatoria que constará en el  Convenio)', 40, 585, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.beneficiary_institution_id.email, 160, 600, {
                maxWidth: 150,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Número de contacto:(información obligatoria que constará en el Convenio)', 290, 585, {
                maxWidth: 75,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('NOMBRE: ' + this.proyectData.beneficiary_institution_id.name_autorize_by, 395, 585, {
                maxWidth: 150,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Contacto: ' + this.proyectData.beneficiary_institution_id.phone, 395, 610, {
                maxWidth: 150,
                align: 'justify'
            });
            this.doc.line(40, 630, 555, 630);
            ...
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Provincia:', 160, 645, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Pichincha', 225, 645, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Canton:', 160, 665, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Quito', 225, 665, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Dirección Matriz:', 40, 655, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Direccion:', 160, 685, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Guayabamba', 225, 685, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Provincia:', 160, 705, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Pichincha', 225, 705, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Dirección Matriz2:', 40, 725, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Canton', 160, 725, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Quito', 225, 725, {
                maxWidth: 100,
                align: 'justify'
            });
            ...
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Dirección', 160, 745, {
                maxWidth: 100,
                align: 'justify'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Guayabamba', 225, 745, {
                maxWidth: 100,
                align: 'justify'
            });
        ...
        const pageContent2 = (data : any) => { // HEADER
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.description, 160, 170, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Ley Orgánica de Educación Superior -LOES', 45, 270, {
                maxWidth: 120,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Art. 87.- Requisitos previos a la obtención del grado académico.- Como requisito previo a la obtención del ' + 'grado académico, los y las estudiantes deberán acreditar servicios a la comunidad mediante programas,' + 'proyectos de vinculación con la sociedad, prácticas o pasantías pre profesionales con el debido ' + 'acompañamiento pedagógico, en los campos de su especialidad.', 160, 240, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Las partes de común acuerdo diseñarán un plan de actividades académicas que' + 'desarrollarán los estudiantes en la ENTIDAD RECEPTORA de acuerdo al número' + 'de horas de vinculación establecidas en el proyecto de carrera y malla curricular' + 'de la carrera de Tecnología en DESARROLLO DE SOFTWARE, dicho plan de' + 'actividades complementará el aprendizaje y la aplicación de conocimientos,' + 'desarrollo de destrezas y habilidades que se consideren necesarias para un' + 'adecuado desempeño de su futura profesión.', 160, 315, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Del Instituto:', 160, 385, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.text('a) Determinar el número de estudiantes participantes en la realización del proyecto de' + 'vinculación con la sociedad conforme a las áreas y espacios definidos por la entidad' + 'receptor', 160, 395, {
                maxWidth: 350,
                align: 'justify'
            });

            this.doc.text('b) Considerar el número de horas determinados para la realización del proyecto de' + 'vinculación con la sociedad conforme establece al proyecto de carrera y/o ' + 'planificación en el ciclo académico', 160, 420, {
                maxWidth: 350,
                align: 'justify'
            });

            this.doc.text('c) Definir un cronograma de actividades para la ejecución del proyecto de vinculación' + 'con la sociedad acorde al perfil de la carrera', 160, 445, {
                maxWidth: 350,
                align: 'justify'
            });

            this.doc.text('d) Designar a los estudiantes de las carreras de Tecnología en DESARROLLO' + 'DE SOFTWARE, a fin de que implementen el proyecto de vinculación' + 'conforme a las competencias y conocimientos adquiridos en el lugar o' + 'ubicación definido por la ENTIDAD RECEPTORA, remitiendo para el efecto' + 'la base de datos con la información que acuerden las partes;', 160, 470, {
                maxWidth: 350,
                align: 'justify'
            });


            this.doc.text('e) Planificar, monitorear, y evaluar la ejecución del proyecto de vinculación en ' + 'coordinación con el tutor que designe la ENTIDAD RECEPTORA;', 160, 520, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.line(160, 670, 555, 670);

            this.doc.text('f) Designar un tutor, cuya responsabilidad es el debido seguimiento a los ' + 'estudiantes que acoja la ENTIDAD RECEPTORA;     ', 160, 555, {
                maxWidth: 350,
                align: 'justify'
            });

            this.doc.text('g) Velar para que los estudiantes de la carrera de Tecnología DESARROLLO ' + 'DE SOFTWARE, ejecuten las actividades del proyecto de vinculación y se ' + 'sometan a las políticas, directrices, reglamentos e instrucciones del ' + 'INSTITUTO y de la ENTIDAD RECEPTORA;', 160, 580, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.line(160, 670, 555, 670);

            this.doc.text('h) Cumplir a cabalidad las horas establecidas para el proyecto;', 160, 620, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.line(160, 670, 555, 670);
            this.doc.text('De la entidad receptora:', 160, 680, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.text('a) Definir el número de estudiantes participantes en la realización del proyecto de' + 'vinculación con la sociedad conforme a las áreas, espacios y/o actividad ' + 'económica de la entidad receptora', 160, 695, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.text('b) El número de estudiantes que acoja la ENTIDAD RECEPTORA se ' + 'determinará al inicio del ciclo académico según su capacidad;', 160, 720, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.line(160, 670, 555, 670);
        ...
        const pageContent3 = (data : any) => { // HEADER
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('c) Garantizar que los estudiantes de la carrera de Tecnología EN' + 'DESARROLLO DE SOFTWARE, efectúen las actividades planificadas' + 'del proyecto de vinculación en las áreas y  espacios acordados por las ' + 'partes;', 160, 150, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('d) Otorgar el apoyo necesario para el desarrollo de los estudiantes y sus' + 'actividades, además de evaluar el desarrollo de las actividades que se ' + 'asignen a los estudiantes dentro de las actividades de vinculación a ' + 'realizarse.', 160, 195, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('e) Emitir un informe de evaluación a los estudiantes que participaron en la' + 'ejecución del proyecto de vinculación con la sociedad conforme a las ' + 'actividades planificadas y principio de retribución de conocimientos.', 160, 240, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('f) Emitir los certificados correspondientes a los estudiantes que hayan ' + 'cumplido exitosamente con la ejecución del proyecto de vinculación.', 160, 290, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Administradores del convenio.', 40, 685, {
                maxWidth: 75,
                align: 'justify'
            });

            this.doc.text('Por el Instituto:', 160, 685, {
                maxWidth: 75,
                align: 'justify'
            });

            this.doc.text('Coordinador de Carrera', 265, 685, {
                maxWidth: 150,
                align: 'justify'
            });

            this.doc.text('Por le Entidad Receptora: ', 385, 685, {
                maxWidth: 150,
                align: 'justify'
            });
            ...
            this.doc.setFont("Roboto", 'bold');
            this.doc.line(40, 730, 555, 730);
            this.doc.text('Nota: Los administradores y/o delegados del convenio no podrán ser los mismos suscribientes', 45, 745, {
                maxWidth: 450,
                align: 'justify'
            });
        ...
        const pageContent4 = (data : any) => {
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Justificación:(Explique la pertinencia de ' + 'la suscripción del Convenio)', 45, 190, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.justification, 160, 170, {
                maxWidth: 500,
                align: 'justify'
            });
            // this.doc.line(40, 225, 555, 225);
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Documento de creación del IST', 45, 310, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.code, 160, 315, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Nombre del Rector/a del IST:', 45, 335, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text('Iván Borja', 160, 335, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('No. De acción de personal del Rector/a del IST:', 45, 360, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.code, 160, 360, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.line(40, 380, 555, 380);
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Nombre de la/s carrera/s:', 45, 395, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.career_id.name, 160, 395, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.line(40, 410, 555, 410);
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('No. Resolución de aprobación, de cada carrera:', 45, 420, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.code, 160, 430, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Vinculación con la sociedad', 255, 460, {
                maxWidth: 250,
                align: 'left'
            });
            ...
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Nombre del proyecto: ', 45, 480, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.name, 160, 480, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Objeto del Proyecto:', 45, 520, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.description, 160, 520, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Número de Participantes:', 45, 550, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.beneficiary_institution_id.number_students_start, 160, 550, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Financiamiento:', 45, 580, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.foundation, 160, 580, {
                maxWidth: 350,
                align: 'justify'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Conclusiones y Recomendaciones', 250, 605, {
                maxWidth: 350,
                align: 'left'
            });
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Recomendaciones: (deberá constar en los antecedentes del ' + 'convenio a suscribir)', 40, 640, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.recommendation, 160, 640, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.line(40, 685, 555, 685)
            ...
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto", 'bold');
            this.doc.text('Conclusiones: (deberá constar en los antecedentes del ' + 'convenio a suscribir)', 40, 700, {
                maxWidth: 100,
                align: 'left'
            });
            this.doc.setFontSize(9);
            this.doc.setFont("Roboto-Regular-normal.ttf", "Roboto-Regular", "normal");
            this.doc.text(this.proyectData.conclusions, 160, 700, {
                maxWidth: 350,
                align: 'justify'
            });
            this.doc.line(40, 750, 555, 750);
        ...
        const pageContent5 = (data : any) => {
            ...
            this.doc.text('*Para el caso de la persona jurídica de derecho privado solicitará el nombramiento debidamente inscrito en el Registro Mercantil.', 40, 450, {
                maxWidth: 500,
                align: 'justify'
            });
            this.doc.text('*Para el caso de la persona jurídica de derecho público solicitará el nombramiento, acción de personal o credencial para el caso de' + 'dignidades de elección popular.', 40, 470, {
                maxWidth: 500,
                align: 'justify'
            });
            this.doc.text('* Para el caso de los delegados se presentará el documento que le acredite. (Acuerdo de Delegación Resolución, otros).', 40, 495, {
                maxWidth: 500,
                align: 'justify'
            });
            this.doc.text('* Para el caso de los mandatarios, se deberá presentar el poder debidamente notariado.', 40, 510, {
                maxWidth: 500,
                align: 'justify'
            });
            this.doc.line(40, 520, 555, 520);
            this.doc.text('Copia simple de la cédula de identidad o pasaporte del representante legal/ delegado o apoderado legalmente' + 'facultado para suscribir convenio', 40, 540, {
                maxWidth: 500,
                align: 'justify'
            });
            this.doc.line(40, 570, 555, 570);
            this.doc.text('Copia simple del Registro Único de Contribuyente (RUC)', 40, 590, {
                maxWidth: 500,
                align: 'justify'
            });
        ...
        this.doc.autoTable({addPageContent: pageContent})
        this.doc.autoTable({addPageContent: pageContent2, startY: 1100})
