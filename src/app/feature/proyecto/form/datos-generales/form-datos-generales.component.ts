...
export class FormDatosGeneralesComponent implements OnInit {
  ...
  public pdf() {
    ...
    const pageContent2 = (data: any) => {
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Debe responder a estas tres preguntas: ¿Qué se va a hacer? ¿Sobre qué? ¿Dónde?',
        85,
        185
      );
      this.doc.setFontSize(9);
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Estudiantes de la carrera de Desarrollo de Software de 4to Y 5to semestre y egresados',
        85,
        260,
        {
          maxWidth: 250,
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Barrio: LA MOYA Calle: JOSE PLACIDO CAAMAÑO Número: S7-136 Intersección: ESPEJO Número de oficina: PB Número de piso: 0 Referencia: JUNTO AL HOGAR DE TRÁNSITO DE MUJERES',
        200,
        285,
        {
          maxWidth: 345,
      ...
      this.doc.setFontSize(9);
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text('05/10/2023', 200, 375, {
        maxWidth: 345,
        align: 'justify',
      });
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        this.miDatePipe.transform(this.proyectData.start_date, 'dd/MM/yyyy'),
        325,
        375,
        {
          maxWidth: 345,
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        this.miDatePipe.transform(this.proyectData.end_date, 'dd/MM/yyyy'),
        450,
        375,
        {
          maxWidth: 345,
      ...
      this.doc.text(
        'EJES ESTRATEGICOS DE VINCULACION CON LA COLECTIVIDAD',
        475,
        525,
        {
          maxWidth: 120,
    ...
    const pageContent4 = (data: any) => {
      ...
      this.doc.line(40, 170, 550, 170);
      this.doc.text('$F{analisis}', 95, 180, {
        maxWidth: 550,
        align: 'center',
      });
      ...
      this.doc.line(40, 450, 555, 450);
      this.doc.text('$F{justificacion', 95, 460, {
        maxWidth: 550,
        align: 'center',
      });
    ...
    const pageContent5 = (data: any) => {
      ...
      this.doc.setFontSize(9);
      this.doc.text(
        'NOMBRES Y APELLIDOS DE COORDINADOR(ES) DE INSTITUCIÓN BENEFICIARIA: ',
        110,
        660,
        {
          maxWidth: 150,
      ...
      this.doc.text(
        'CARGO O FUNCIÓN EN LA INSTITUCIÓN BENEFICIARIA',
        300,
        660,
        {
          maxWidth: 150,
      ...
      this.doc.text(
        'FUNCIÓN QUE CUMPLE EN EL PROYECTO DE VINCULACIÓN CON LA COMUNIDAD.',
        460,
        660,
        {
          maxWidth: 150,
    ...
    const pageContent7 = (data: any) => {
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.setFontSize(9);
      this.doc.text('$F{horario}', 45, 180, {
        maxWidth: 550,
        align: 'justify',
      });
    ...
    const pageContent9 = (data: any) => {
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.setFontSize(9);
      this.doc.text('$F{estrategia}', 45, 180, {
        maxWidth: 550,
        align: 'justify',
      });
      this.doc.line(40, 550, 555, 550);
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.setFontSize(9);
      this.doc.text('$F{estrategia}', 45, 385, {
        maxWidth: 550,
        align: 'justify',
      });
      ...
      this.doc.text('$F{rector}', 275, 645, {
        maxWidth: 100,
        align: 'center',
      });
      ...
      this.doc.text('$F{rector}', 475, 645, {
        maxWidth: 100,
        align: 'center',
      });
      ...
      this.doc.text('$F{rector}', 285, 725, {
        maxWidth: 100,
        align: 'center',
      });
      ...
      this.doc.text('$F{rector}', 475, 725, {
        maxWidth: 100,
        align: 'center',
      });
    };
  ...
  public pdf_convenio() {
    ...
    const pageContent = (data: any) => {
      ...
      this.doc2.text(
        'CONVENIO DE VINCULACIÓN CON LA SOCIEDAD ENTRE EL   ',
        120,
        210
      );
    ...
    const pageContent3 = (data: any) => {
      ...
      this.doc2.text(
        '14. El XXXXXXXXXXXXXXXXX, ubicado en la ciudad de xxxxxxxxx, provincia de xxxxxxx, es una Institución de Educación Superior Pública, con licencia de funcionamiento otorgada mediante Acuerdo Nro. Xxx y registro institucionalNro.Xxxxx conferido por el Consejo de Educación Superior CONESUP, que se dedica a la formación de profesionales de nivel tecnológico.;',
        115,
        650,
        {
          maxWidth: 400,
    ...
    const pageContent4 = (data: any) => {
      ...
      this.doc2.text(
        'a) Designar a las y los estudiantes del INSTITUTO a fin de que accedan a las actividades de vinculación  en la ENTIDAD RECEPTORA, remitiendo para el efecto la base de datos con la información que acuerden las partes.',
        155,
        490,
        {
          maxWidth: 350,
      ...
      this.doc2.text(
        'b) Asegurar que la  unidad de vinculación pueda desarrollar los distintos programas y actividades en las instalaciones existentes en la ENTIDAD RECEPTORA.',
        155,
        540,
        {
          maxWidth: 350,
      ...
      this.doc2.text(
        'a) Permitir que los estudiantes del Instituto Tecnológico Superior xxxxxxxxx efectúen actividades de vinculación en las instalaciones de acuerdo a los lineamientos pedagógicos establecidos.',
        155,
        640,
        {
          maxWidth: 350,
      ...
      this.doc2.text(
        'b) Vincular a las y los estudiantes a las áreas relacionadas con la carrera que se encuentren cursando la correspondiente actividad de vinculación en sus instalaciones, de acuerdo a las necesidades de la ENTIDAD RECEPTORA y de conformidad a la normativa vigente.',
        155,
        685,
        {
          maxWidth: 350,
      ...
      this.doc2.text(
        'c) Otorgar el apoyo necesario para el desarrollo de los estudiantes y sus actividades, además de evaluar el desarrollo de las actividades que se asignen a los estudiantes dentro de las actividades de vinculación  a realizarse en la ENTIDAD RECEPTORA',
        155,
        735,
        {
          maxWidth: 350,
    ...
    const pageContent5 = (data: any) => {
      ...
      this.doc2.text(
        'Por el INSTITUTO se designa al Coordinador de la Carrera.',
        110,
        530,
        {
          maxWidth: 400,
      ...
      this.doc2.text(
        'Por la ENTIDAD RECEPTORA  se designa al Asistente Administrativo',
        110,
        540,
        {
          maxWidth: 400,
    ...
    const pageContent6 = (data: any) => {
      ...
      this.doc2.setFont('Roboto', 'bold');
      this.doc2.text(
        'CLÁUSULA NOVENA. -INEXISTENCIA DE RELACIÓN LABORAL:',
        110,
        340
      );
      this.doc2.setFontSize(11);
      ...
      this.doc2.text(
        'a)	Los que acreditan la calidad y capacidad de los comparecientes; y,',
        120,
        635,
        {
          maxWidth: 400,
      ...
      this.doc2.setFont('Roboto', 'bold');
      this.doc2.text(
        'CLÁUSULA DÉCIMA SEGUNDA.- COMUNICACIONES Y NOTIFICACIONES:',
        110,
        665
      );
      this.doc2.setFontSize(10);
      ...
      this.doc2.text(
        'Todas las comunicaciones y notificaciones entre las partes, se realizarán por escrito y serán entregadas a las siguientes direcciones:',
        110,
        680,
        {
          maxWidth: 400,
    ...
    const pageContent7 = (data: any) => {
      ...
      this.doc2.setFont('Roboto', 'bold');
      this.doc2.text(
        'INSTITUTO TECNOLOGICO SUPERIOR DE PATRIMONIO Y TURISMO YAVIRAC',
        110,
        150
      );
      ...
      this.doc2.text(
        'Dado, en la ciudad de Quito a los           días del mes de            de 202',
        110,
        395,
        {
          maxWidth: 400,
  ...
  public pdf_itv() {
    ...
    const pageContent = (data: any) => {
      ...
      this.doc.text(
        'PARA LA FIRMA DE CONVENIO DE VINCULACIÓN CON LA SOCIEDAD',
        125,
        155
      );
      ...
      this.doc.setFontSize(9);
      this.doc.setFont('Roboto', 'bold');
      this.doc.text('Nombre de la Entidad Receptora:', 40, 270, {
        maxWidth: 100,
        align: 'justify',
      });
      this.doc.setFontSize(9);
      ...
      this.doc.setFont('Roboto', 'bold');
      this.doc.text(
        'Nombre de la persona  autorizada legalmente  para la suscripción del Convenio:',
        40,
        330,
        {
          maxWidth: 100,
      ...
      this.doc.setFont('Roboto', 'bold');
      this.doc.text(
        'N° de estudiantes que recibiría inicialmente la Entidad Receptora:',
        40,
        480,
        {
          maxWidth: 100,
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Total de estudiantes proyectados que recibirá la Entidad Receptora durante la vigencia del convenio:',
        290,
        470,
        {
          maxWidth: 100,
      ...
      this.doc.setFont('Roboto', 'bold');
      this.doc.text(
        'Correo electrónico de la empresa: (información obligatoria que constará en el  Convenio)',
        40,
        585,
        {
          maxWidth: 100,
      ...
      this.doc.setFontSize(9);
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text('majo@gmail.com.edu.ec', 160, 600, {
        maxWidth: 150,
        align: 'justify',
      });
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Número de contacto:(información obligatoria que constará en el Convenio)',
        290,
        585,
        {
          maxWidth: 75,
      ...
      this.doc.setFontSize(9);
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text('NOMBRE:BARRIGA OLIVO SUSANJAC QUELINE', 395, 585, {
        maxWidth: 150,
        align: 'justify',
      });
      this.doc.setFontSize(9);
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text('Contacto: 022342563', 395, 610, {
        maxWidth: 150,
        align: 'justify',
      });
      this.doc.line(40, 630, 555, 630);
      ...
      this.doc.setFont('Roboto', 'bold');
      this.doc.text('Dirección Matriz:', 40, 725, {
        maxWidth: 100,
        align: 'justify',
      });
      this.doc.setFont('Roboto', 'bold');
    ...
    const pageContent2 = (data: any) => {
      ...
      this.doc.text(
        'h) Cumplir a cabalidad las horas establecidas para el proyecto;',
        160,
        620,
        {
          maxWidth: 350,
    ...
    const pageContent5 = (data: any) => {
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Docente del Instituto Superior Tecnológico Yavira',
        220,
        250
      );
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Copia simple de los documentos que acrediten la calidad del Representante Legal/ delegado o apoderado.',
        40,
        430
      );
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Copia simple de la acción de personal del Rector vigente y debidamente legalizado',
        40,
        645
      );
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Copia simple de la cédula de identidad del rector ',
        40,
        665
      );
      ...
      this.doc.setFont('Roboto-Regular-normal.ttf', 'Roboto-Regular', 'normal');
      this.doc.text(
        'Resolución de aprobación, registro o regularización de la/s carrera/s expedido por el CES',
        40,
        705
      );
