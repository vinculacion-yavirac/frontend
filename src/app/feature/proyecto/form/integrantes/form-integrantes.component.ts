...
import { Integrantes } from 'src/app/models/proyecto/integrantes.models';

@Component({
  selector: 'app-form-integrantes',
  templateUrl: './form-integrantes.component.html',
  styleUrls: ['./form-integrantes.component.css']
})
export class FormIntegrantesComponent implements OnInit {
